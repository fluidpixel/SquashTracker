...
class HelloWorld: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let xValues = Array(0.stride(through: 16, by: 2)).map {ChartAxisValueInt($0, labelSettings: labelSettings)}
        let yValues = Array(0.stride(through: 16, by: 2)).map {ChartAxisValueInt($0, labelSettings: labelSettings)}
